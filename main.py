...
def respond(voice_data):
    ...
    if there_exists(["capture","my screen","screenshot"]):
        ...
        myScreenshot.save('Desktop:/screenshot/screen.png')
...
if __name__=="__main__":
    ...
    Listen_Button=tk.Button(root,borderwidth=0,activebackground='#2c4557',bg='#2c4557',command=ran_app)
