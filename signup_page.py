...
class SignUp:
    def __init__(self, root):
        ...
        title1 = Label(frame, text="Sign Up", font=("times new roman",25,"bold"),bg="white", fg="black").place(x=20, y=10)
        title2 = Label(frame, text="Join with us", font=("times new roman",13),bg="white", fg="blue").place(x=20, y=50)

        f_name = Label(frame, text="First name", font=("helvetica",15,"bold"),bg="white", fg="black").place(x=20, y=100)
        l_name = Label(frame, text="Last name", font=("helvetica",15,"bold"),bg="white", fg="black").place(x=240, y=100)
        ...
        email = Label(frame, text="Email", font=("helvetica",15,"bold"),bg="white", fg="black").place(x=20, y=180)

        self.email_txt = Entry(frame,font=("arial"))
        self.email_txt.place(x=20, y=210, width=420)

        sec_question = Label(frame, text="Security questions", font=("helvetica",15,"bold"),bg="white", fg="black").place(x=20, y=260)
        answer = Label(frame, text="Answer", font=("helvetica",15,"bold"),bg="white", fg="black").place(x=240, y=260)
        ...
        password =  Label(frame, text="New password", font=("helvetica",15,"bold"),bg="white", fg="black").place(x=20, y=340)

        self.password_txt = Entry(frame,font=("arial"))
        self.password_txt.place(x=20, y=370, width=420)

        self.terms = IntVar()
        terms_and_con = Checkbutton(frame,text="I Agree The Terms & Conditions",variable=self.terms,onvalue=1,offvalue=0,bg="white", fg="black",font=("times new roman",12)).place(x=20,y=420)
        self.signup = Button(frame,text="Sign Up",voice_data=self.signup_func,font=("times new roman",18, "bold"),bd=0,cursor="hand2",bg="green2",fg="white").place(x=120,y=470,width=250)
