...
class LoginP:
    ...
    def __init__(self, root):
        self.window = root
        self.window.title("Log In Alexa virtual Assistance")
        # Set the window size
        ...
        label1 = Label(self.frame1, text= "Alexa", font=("times new roman", 40, "bold"), bg="yellow", fg="red").place(x=100,y=300)
        label2 = Label(self.frame1, text= "virtual", font=("times new roman", 40, "bold"), bg="yellow", fg="RoyalBlue1").place(x=162,y=360)
        label3 = Label(self.frame1, text= "Assistance", font=("times new roman", 30, "bold"), bg="yellow", fg="brown4").place(x=175,y=420)
        ...
        #================Buttons===================
        self.login_button = Button(self.frame3,text="Log In",voice_data=self.login_func,font=("times new roman",15, "bold"),bd=0,cursor="hand2",bg="blue",fg="white").place(x=50,y=200,width=300)

        self.forgotten_pass = Button(self.frame3,text="Forgotten password?",voice_data=self.forgot_func,font=("times new roman",10, "bold"),bd=0,cursor="hand2",bg="white",fg="blue").place(x=125,y=260,width=150)

        self.create_button = Button(self.frame3,text="Create New Account",voice_data=self.redirect_window,font=("times new roman",18, "bold"),bd=0,cursor="hand2",bg="green2",fg="white").place(x=80,y=320,width=250)


    def login_func(self):
        #from main import run_alexa
        if self.email_entry.get()=="" or self.password_entry.get()=="":
            ...
            try:
                ...
                if row == None:
                    ...
                    messagebox.showinfo("Success","Wellcome to the Alexa virtual Assistance",parent=self.window)
        ...
        if self.email_entry.get()=="":
            ...
            try:
                ...
                if row == None:
                    ...
                    self.create_button = Button(self.root,text="Submit",voice_data=self.change_pass,font=("times new roman",18, "bold"),bd=0,cursor="hand2",bg="green2",fg="white").place(x=95,y=340,width=200)
                    #=========================================================================
